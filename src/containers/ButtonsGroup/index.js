...
class ButtonsGroup extends Component {
  handleInputChange = (number) => () => this.props.changeInputAction(number);

  handleOperationChange = (operation) => () => this.props.changeOperationAction(operation);
...
ButtonsGroup.propTypes = {
  changeInputAction: PropTypes.func,
  changeOperationAction: PropTypes.func,
  clearInputAction: PropTypes.func,
  evaluateExpressionAction: PropTypes.func,
};
